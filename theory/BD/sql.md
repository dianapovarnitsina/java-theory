...
Другими словами, с помощью операторов, входящих в эту группы,
Т.е. эта группа операторов определяет структуру базы данных и работаем с объектами этой базы, т.е. `создаем, изменяем и удаляем` их.
...
`Transaction Control Language (TCL)` – группа операторов для управления транзакциями. <br>
